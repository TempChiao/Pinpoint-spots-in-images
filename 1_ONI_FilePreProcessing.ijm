...
leftChSuffix = "NR"; // Suffix to be added to saved file name
rightCh = false; // indicate if data captured on right chip (i.e. 640 nm plus emission)
rightChSuffix = "Atto655"; // Suffix to be added to saved file name
