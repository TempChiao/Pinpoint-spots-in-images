...
path = r'/Volumes/RSaleeb_2TB/2023-09-26_EV-Pulldown_BuckLab/TwoCh/Analysis/'
            ...
            if file.endswith('Test-Results.csv') and not file.startswith('._'):
                ...
                with open(path + folder + '/' + file) as f:
                    ...
                    try:
                        ...
                        appendRows = events.loc[(events['ColocCh1'] == 1) & (events['ColocCh2'] == 1) & (events['Channel'] == 1)] # For coincident events
